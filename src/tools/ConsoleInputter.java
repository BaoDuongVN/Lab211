...
public class ConsoleInputter {
    ...
    */
    ...
    /*
        Nhập 1 chuỗi theo mẫu quy định (pattern). Vì pattern có nhiều dạng nên trong prompt nên có lời giải thích về mẫu nhập. Nếu user nhập sai, một
        thông báo errorMsg được xuất ra. Thí dụ một cách dùng:
        String phone = getStr("Phone no.", "[\\d]{9}|[\\d]{11}", "Phone: 9/11 digits!"); Tham khảo thêm về Regular Expression cho mô tả pattern:
    ...
    */
    ...
    public static String getStr(String prompt, String pattern, String errorMsg) {
        ...
        do{
            ...
            if(!valid) System.out.println(errorMsg); //Không trùng mẫu thì hiện thông báo lỗi ra cho người dùng
    ...
    /*
        ...
        ở đây hành vi parse(...) của lớp DateFormat được dùng. Hành vi này sẽ tự động điều chỉnh ngày lên xuống để có ngày kết quả phù hợp.
        Thí dụ 32-12-2024 sẽ chuyển thành 01/01/2025.
        Nếu không muốn dùng cơ chế tự động này, bạn cần tự viết lấy cơ chế chuyển đổi, Cách làm được đề nghị:
        - Nhập chuỗi
    ...
    */
    ...
    /*
        Thay vì xây dựng lớp cho Menu, hàm menu được xây dựng. Cú pháp DataType...(hàm có số đối sô thay đổi)
